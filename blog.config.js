...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '181af345e78e80a69574cbfed6d0a59e',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'from ZJU CS', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-alpha-two-52.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科研, 课程笔记', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://beian.miit.gov.cn/', // 备案查询链接，如果用了萌备等备案请在这里填写
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'dongqianyu99@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/dongqianyu99', // 你的github个人主页 例如 https://github.com/tangly1024
